...
function rowToShape(row: StoreSettings) {
  return {
...
type StoreSettingsUpdate = Partial<
  Pick<
    StoreSettings,
    | 'contact_email'
    | 'contact_phone'
...
function shapeToRowPatch(shape: StoreSettingsShape): StoreSettingsUpdate {
...
export async function GET() {
  try {
    ...
    return NextResponse.json(rowToShape(data));
  } catch (err) {
