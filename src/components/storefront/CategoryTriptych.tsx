...
const CARDS: ReadonlyArray<Card> = [
  {
    ...
    href: '/shop/niche',
    image: '/images/niche-bench.webp',
    imageAlt: "A perfumer's bench at evening: four unlabeled apothecary bottles, a glass pipette, an unlit beeswax taper, and a linen blotter on dark walnut.",
  },
  {
    ...
    href: '/shop/lattafa',
    image: '/images/lattafa-oud.webp',
    imageAlt: 'A tall amber-mahogany perfume bottle on oxblood linen at golden hour, with raw amber resin, oudh wood chips, and a dried rose beside an open cedar box.',
  },
  {
    ...
    image: '/images/essence-oils.webp',
    imageAlt: "Three amber-glass essence oil droppers on cool bone linen, beside a brass dish of dried orange peel and jasmine, a folded blotter, and a beeswax taper.",
  },
];
