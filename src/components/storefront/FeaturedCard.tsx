      ...
      >
        ...
        >
          <Image
            ...
            className="object-contain p-0 transition-transform duration-[600ms] ease-[var(--ease-out-quart)] group-hover:scale-[1.02]"
          />
          {showCrossfade && (
            <Image
              src={secondary}
              ...
              fill
              sizes={styles.imageSizes}
              className="object-contain p-0 opacity-0 transition-opacity duration-[var(--duration-base)] ease-[var(--ease-out-quart)] group-hover:opacity-100"
            />
          )}
